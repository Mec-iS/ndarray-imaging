...
axs[1,0].set_title("grayscale - inverted threshold 200 grayscale")
axs[1,0].imshow(grayscale_img1 - inverted_threshold(grayscale_img1, thresh=220), cmap="gray")
